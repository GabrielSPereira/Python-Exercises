...
def percentualCalcula(lista, num):   
    ...
    num = num / sum(lista)
    return num
# arqEntrada = open("C:/Users/GABRIEL/Desktop/Escola/IFSP/Python-Exercises/Lista06/Exer02Lista06/usuarios.txt", "r")
...
# arqSaida = open("C:/Users/GABRIEL/Desktop/Escola/IFSP/Python-Exercises/Lista06/Exer02Lista06/relatorio.txt", "w")
